...
{
    public class EmployeesForMusicController : Controller
    {
        private KLoveDBEntities db = new KLoveDBEntities();

        // GET: EmployeesForMusic
        public ActionResult Index(int? favoriteSongId)
        {
            if (favoriteSongId != null)
            {                
                return View(db.Employees.Where(emp => emp.favoriteSongId == favoriteSongId.Value).ToList());
            }
            return View(db.Employees.ToList());
        }

        // GET: EmployeesForMusic/Details/5
        ...
        // GET: EmployeesForMusic/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: EmployeesForMusic/Create
        ...
        // GET: EmployeesForMusic/Delete/5
        ...
        // POST: EmployeesForMusic/Delete/5
