...
namespace KLoveEmployeeManagement.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Index(int? departmentId)
        {
            ...
            {
                return View(db.Employees.Where(emp => emp.departmentId == departmentId).ToList());
            }
        ...
        public ActionResult Create([Bind(Include = "firstName,lastName,login,active,hireDate,departmentId,addressLine1,addressLine2,city,state,zipcode,cellPhone,officePhone,email,salary,favoriteSongId")] Employee employee)
        {
