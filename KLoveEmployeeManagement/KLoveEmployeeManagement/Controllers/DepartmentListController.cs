...
namespace KLoveEmployeeManagement.Controllers
{
    public class DepartmentListController : Controller
    {
        ...
        // GET: DepartmentList/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: DepartmentList/Create
