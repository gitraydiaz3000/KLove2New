...
namespace KLoveEmployeeManagement.Controllers
{
    public class EmployeesDepartmentsController : Controller
    {
        ...
        // GET: EmployeesDepartments
        public ActionResult Index(int? depID)
        {
           
            if (depID != null)
            { 
            List<Employee> employees = db.Employees.Where(emp => emp.departmentId == depID.Value).ToList();
        ...
        // GET: EmployeesDepartments/Details/5
        ...
        // GET: EmployeesDepartments/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: EmployeesDepartments/Create
        ...
        // GET: EmployeesDepartments/Edit/5
        ...
        // POST: EmployeesDepartments/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: EmployeesDepartments/Delete/5
        ...
        // POST: EmployeesDepartments/Delete/5
